...
vector_float3 DragonflyUtils::DistancePolynomial(vector_float3 start, vector_float3 vector, vector_float3 origin) {
    ...
    start.y -= origin.y;
    start.z -= origin.z;
    vector_float3 x = vector_make_float3(pow(vector.x, 2), 2 * start.x * vector.x, pow(start.x, 2));
    vector_float3 y = vector_make_float3(pow(vector.y, 2), 2 * start.y * vector.y, pow(start.y, 2));
    vector_float3 z = vector_make_float3(pow(vector.z, 2), 2 * start.z * vector.z, pow(start.z, 2));
